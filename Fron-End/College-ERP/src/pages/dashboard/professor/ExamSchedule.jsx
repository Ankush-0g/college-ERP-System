...
export default function ExamSchedule() {
  ...
  const departmentId = user.departmentId || user.department || 1;
  ...
  const fetchExamSchedules = async () => {
    setLoading(true);
    try {
      // Get upcoming exams for the professor's department
  ...
  return (
    <div className="mt-6 space-y-6">
      <Typography variant="h5">Department Exam Schedule</Typography>
